...
## 🗒 项目简介
区块链工程师学习路线中文翻译，该项目的思维导图和文档翻译自[全GitHub所有项目中Star数排名](https://github.com/search?q=stars%3A%3E200000&type=Repositories)第六位的[Develop Roadmap](https://roadmap.sh)项目的区块链工程师([Blockchain Developer](https://roadmap.sh/blockchain)) 部分。

该翻译项目目前有PDF、OPML、HTML、PNG、FreeMind等格式文档
...
网页版Wiki已上线： [Web3-Wiki](https://web3wiki.site/)
